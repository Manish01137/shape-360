  ...
  useEffect(() => {
    ...
    const addHoverListeners = () => {
      const interactiveEls = document.querySelectorAll(
        "a, button, .thm-btn, .hamburger, .swiper-pagination-bullet, input, textarea, select, .project-card, .svc-card, .service-item, .why-card, .process-card, .extra-card, .testimonial-card, .value-card, .info-card, .nav-cta, .hscroll-card, .landing-card, .cs-card, .cs-landing-card, .blog-card, .blog-featured-card, .team-card, .career-card, .pricing-card, .ad-pricing-card, .faq-question, .chatbot-fab"
      );
