    ...
    <>
      ...
      <div className={`mobile-menu ${open ? "open" : ""}`}>
        ...
        <div className="mobile-menu-content">
          {/* AutoFlow Featured */}
          <NavLink to="/automate" onClick={closeAll} className="mobile-automate-card">
            <div className="mobile-automate-icon">
            ...
            <div className="mobile-automate-body">
              <div className="mobile-automate-head">
                <span>AutoFlow</span>
                <span className="mobile-automate-badge">NEW</span>
              </div>
              <p>AI automation tool — coming May 2026. Join the waitlist.</p>
            </div>
            <span className="mobile-automate-arrow">&#8594;</span>
          </NavLink>
          ...
          <div className="mobile-menu-footer">
            ...
            <div className="mobile-contact">
              <a href="mailto:manish@shape360ai.com">
