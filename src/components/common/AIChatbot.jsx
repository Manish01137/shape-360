...
• WorkSaura (worksaura.com) — Cinematic scroll-driven portfolio for Rahul, a New Delhi-based graphic and 3D designer. Showcase reel, brand identity case studies (DLF Healthcare, Omnist Techhub, VINR Skincare, Crew Solutions, Webslogin IT, Global Sports, Fashion Comfartz, London Camera & Antique Auction), tools mastery (Photoshop, Illustrator, After Effects, 3ds Max, Maya, KeyShot), career journey timeline, and client testimonials. Built with React + Vite + GSAP ScrollSmoother + Framer Motion
