      ...
      <section className="cs-landing">
        <div className="container">
          ...
          <div className="cs-landing-grid">
            {[
              { title: "Biospire Lifesciences", category: "Pharmaceutical Brand · 🇮🇳 Bharat", link: "https://biospirelifesciences.com", img: "https://images.unsplash.com/photo-1631549916768-4119b2e5f926?w=600&q=80", desc: "Nagpur-based pharmaceutical brand (Est. June 2025) — WHO-GMP and ISO 9001:2015 certified. Landing page architected around 'Partner in Progressive Healthcare' philosophy, surfacing the Biospire promise to doctors, pharmacists, and patients across Bharat — with WhatsApp partner-inquiry flow." },
