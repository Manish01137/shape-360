...
const Home = () => {
  ...
  const projects = [
    { title: "IndiColas", category: "Craft Soda Brand · 🇺🇸 USA", link: "https://indicolas.com", img: "https://indicolas.com/images/bottles-sky.png", desc: "Heritage-inspired craft soda brand bringing India's iconic Goli Soda culture to the US market — 12 bold flavors, a cinematic video-first storefront, creator testimonials, and a 'Pop The Fizz' community." },
    ...
    { title: "WorkSaura", category: "Creative Designer Portfolio · GSAP", link: "https://worksaura.com", img: "https://images.unsplash.com/photo-1626785774573-4b799315345d?w=600&q=80", desc: "Cinematic scroll-driven portfolio for Rahul — a graphic and 3D designer in New Delhi serving brands like DLF Healthcare, Omnist Techhub, VINR Skincare and Crew Solutions. Built with React + GSAP + ScrollSmoother for showreel-grade transitions, project case studies, design tool stack, and a career timeline." },
  ...
  const testimonials = [
    ...
    { text: "Shape-360 turned my portfolio into a cinematic experience. The scroll animations, the showreel integration, and the way each client case is presented — it now feels like a film, not a folder. Client inquiries have changed from 'are you available?' to 'when can we start?'.", name: "Rahul", role: "Founder, WorkSaura · New Delhi", stars: 5 },
